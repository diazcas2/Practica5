...
outliersiris<-clean_iris %>% mutate(across(Petal.Length,list(outliers_3sigma= ~reglasigma(.x),outliers_Hampel=~reglahampel(.x),outliers_boxplot=~reglaboxplot(.x),outliers_percentiles=~reglapercentil(.x))))
