...
complete.cases(iris_clean$Longitud_Sepalo)
sum(complete.cases(iris_clean$Longitud_Sepalo))
nrow(iris_clean)

porc_longsep<-sum(complete.cases(iris_clean$Longitud_Sepalo))/nrow(iris_clean) *100
porc_longsep

porc_anchsep<-sum(complete.cases(iris_clean$Ancho_Sepalo))/nrow(iris_clean) *100
porc_anchsep

porc_longpet<-sum(complete.cases(iris_clean$Longitud_Petalo))/nrow(iris_clean) *100
porc_longpet
